    ...
    <div class="h-92 flex flex-row">
                    ...
                    <div class="home-content">
                        ...
                        <div class="mobile-info w-75 flex mb4 float-right">
                            <div class="w-100 pa3 facts bg-purple">
                                ...
                                <p>Population: 2</p>
                                <br>
                                <p>Hey there! Take a look around and click on stuff to find out more. I hope you see
                        ...
                        <div class="item mt4">
                            <div class="margin-a w-60">
                                <img class="w-100 bright shrink" src="~/assets/img/art/Katrina-Stalcup-Art-27.jpeg" alt="">
                            </div>
                        </div>
                        <div class="flex flex-row">
                            ...
                            <div class="item w-60">
                                <div class="w-80 mt9 margin-a">
                                    <img class="w-100 grow" src="~/assets/img/art/Katrina-Stalcup-Art-12.jpeg" alt="">
                                </div>
                            </div>
                            <div class="spacer"></div>
                        </div>
                        <div class="mobile-info w-60 flex mb4 text-center">
                            <div class="w-100 pa3 facts bg-purple">
                                <p>CONTACT</p>
                                <p>kat.stalcup@gmail.com</p>
                                <p>Studio IG @samewave7</p>
                            </div>
                        </div>
        ...
        <div class="info-section w-20 flex pr3 pb3">
            <div class="w-100 pa4 facts bg-purple overflow-y">
                ...
                <p>Population: 2</p>
                <br>
                <p>Hey there! Take a look around. I hope you see something that inspires
                    you. </p>
                <div class="item mt5 mb5 margin-a">
                    <div class="w-100">
